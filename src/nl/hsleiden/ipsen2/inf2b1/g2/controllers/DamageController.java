...
public class DamageController implements ActionListener{
        ...
        public void actionPerformed(ActionEvent e) {
                if(e.getSource() == garageView.searchButton){
                        ...
                        if(vehicleID != 0){
                                ...
                                JOptionPane.showMessageDialog(null, "Geen geldige invoer","Ongeldig", JOptionPane.ERROR_MESSAGE);
                        }
                }
                        ...
                        JOptionPane.showMessageDialog(null,
                                        "Voertuig is goedgekeurd voor verhuur", "Succes", JOptionPane.QUESTION_MESSAGE);
        ...
        {        
                ...
                garageView.customerNumberLabel.setText(Integer.toString(c.getCustomerNumber()));
                ...
                garageView.damageTablePanel.removeAll();
                        // Create the table
                garageView.damageTablePanel.add(new JScrollPane(viewDamagePerID(r.getVehicleId())));
        }
